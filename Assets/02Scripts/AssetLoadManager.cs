...
namespace DUS.AssetLoad
{
    public class AssetLoadManager : MonoBehaviour
    {
        ...
        public void SetNextSceneNeedAddressable(List<string> nextSceneNeedAddressableList = null)
        {
            if (nextSceneNeedAddressableList == null || nextSceneNeedAddressableList.Count == 0)
            {
                Debug.LogError("Next scene need addressable list is empty or null.");
                return;
            }
